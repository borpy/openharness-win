...
import { type KeyEvent, startRawInput } from "./input.js";
import { type LayoutState, rasterizeLive, type ToolCallInfo } from "./layout.js";
import {
  browserDown,
  browserLoadPreview,
  browserSearch,
...
export class TerminalRenderer {
  ...
  setContextWarning(warning: { text: string; critical: boolean } | null): void {
